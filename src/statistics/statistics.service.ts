...
export class StatisticsService {
    ...
    async getMainStatistics() {
        const countUses = await this.prisma.user.count()
    ...
    async getMiddleStatistics() {
        ...
        //Получение продаж за последние 2 недели
